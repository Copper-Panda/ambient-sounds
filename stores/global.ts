...
export const useSoundStore = defineStore('sound', () => {
	const sounds = reactive([
		{name: 'rain', src: '/sounds/rain.wav', dom: null, isPlaying: false, iconName:'solar:cloud-rain-linear'},
		...
		{name: 'WhiteNoise', src: '/sounds/whiteNoise.wav', dom: null, isPlaying: false, iconName:'solar:cloud-rain-linear'},
	])
